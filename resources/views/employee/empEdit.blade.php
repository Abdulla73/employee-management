                    ...
                    <div class="entry">
                        ...
                        <div class="half-width-container">
                            <div class="form-group half-width">
                                ...
                                <input type="number" name="passing_year[]" value="{{ $education->passing_year }}" required>
                            </div>
                            <div class="form-group half-width">
                ...
                @foreach ($employee->histories ?? [] as $history)
                    <div class="entry">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="employment_institute[]" value="{{ $history->institute }}" required>
                        </div>
                        <div class="half-width-container">
                            <div class="form-group half-width">
                            ...
                            <div class="form-group half-width">
                                ...
                                <input type="date" name="end_date[]" value="{{ $history->end_date }}" style="margin-bottom: 5px;">
                                <div class="checkbox-container">
                                    <input type="checkbox" style="margin-right: 5px;" onclick="toggleEndDate(this, 'end_date_{{ $loop->index }}')">
        ...
        employmentEntry.innerHTML = `
            ...
            <div class="half-width-container">
                ...
                <div class="form-group half-width">
                    ...
                    <input type="date" name="end_date[]" style="margin-bottom: 5px;" required>
                    <div class="checkbox-container">
                        <input type="checkbox" style="margin-right: 5px;" onclick="toggleEndDate(this, 'end_date_' + employmentCount)">
